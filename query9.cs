...
namespace blood_bank_management_system
{
    public partial class query9 : Form
    {
        ...
        public void loadData()
        {
            ...
            {
                con.Open();
                SqlDataAdapter sda2 = new SqlDataAdapter("select d1.fname,d1.lname from doni d1 where d1.qty>0 and d1.place<>(select d2.place from donor1 d2 where d1.sids=d2.sids)", con);
